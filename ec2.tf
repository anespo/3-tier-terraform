...
resource "aws_instance" "3-tier-tony" {
  ...
  vpc_security_group_ids = ["${ aws_security_group.3-tier-tony-security-group.id }"] # attaching security group
